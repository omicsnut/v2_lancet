    ...
    for (seq_j = 0; seq_j < len_j; seq_j++) {
        for (seq_i = 0; seq_i < len_i; seq_i++) {
            ...
            if (scoring->no_mismatches && !is_match) {
                ...
                match_scores[index] = MAX4(match_scores[index_upleft] + substitution_penalty,
            ...
            if (seq_i == len_i - 1 && scoring->no_end_gap_penalty) {
                ...
                gap_a_scores[index] = MAX4(match_scores[index_up] + gap_open_penalty,
            ...
            if (seq_j == len_j - 1 && scoring->no_end_gap_penalty) {
                ...
                gap_b_scores[index] = MAX4(match_scores[index_left] + gap_open_penalty,
